<?php
    ...
    class MagicToolboxCoreInstallerClass {
        ...
        function sendStat($mode = '') {
            ...
            if('working' == 'v4.4.3' || 'working' == 'v5.2.5') {
                return;
            }
            ...
            $path = "api/stat/?action={$mode}&tool_name=magiczoomplus&license=trial&tool_version=v5.2.5&module_version=v4.4.3&platform_name=opencart&platform_version={$platformVersion}&url={$url}";
